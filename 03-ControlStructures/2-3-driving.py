...
if driving_mode == 'A':
    ...
    raise ValueError('Provide correct diving mode (A/M/E)')

total_consumption = distance / 100 * fuel_consumption
print(f'Total fuel consumption over a distance of {distance} km in driving mode {driving_mode} '
      f'is {total_consumption} liters')